...
def falar_texto(texto):
    ...
    try:
        ...
        ### COMPLETE AQUI ###
        # Crie o objeto de configuração SpeechConfig
        speech_config = speech_sdk.SpeechConfig(subscription=speech_key, region=speech_region)

        # Configure a voz (ex.: pt-BR-FranciscaNeural)
        ### COMPLETE AQUI ###
        speech_config.speech_synthesis_voice_name = "pt-BR-FranciscaNeural"

        ### COMPLETE AQUI ###
        # Configure para usar o alto-falante padrão
...
def obter_resposta_ia(mensagens_historico):
    ...
    try:
        response = client.chat.completions.create(
            ...
            ### COMPLETE AQUI ###
            # Passe o histórico da conversa como parâmetro
            messages=mensagens_historico,
            temperature=1.0,
            max_tokens=5000,
        )

        # Retorne o conteúdo da resposta da IA
